...
def handler(context, event):
    try:
        ...
        if(context.user_data.image_hash != image_hash):
            ...
            print("Time taken to embed img: ", time.time() - start)
        ...
        print("input_point", input_point, input_point.shape, "input_label", input_label, input_label.shape)
        ...
        print("Time taken to compute mask: ", time.time() - start)


        print("masks", masks.shape, "scores", scores, scores.shape, "logits", logits.shape)
